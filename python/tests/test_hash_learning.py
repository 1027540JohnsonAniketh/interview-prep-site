"""Tests for hash learning package using unittest."""

import unittest

from hash_learning.agents_learning_module import agent_quiz_checks, agent_study_plan
from hash_learning.validate_module import run_all_validations


class TestHashLearning(unittest.TestCase):
